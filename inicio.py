...
def main(page:ft.Page):
    ...
    txt2=ft.Text('VESTIDOS',
                  ...
                  font_family='times new roman',
                  italic=True)
    img2=ft.Image(src='vestidosM.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txt4=ft.Text('PLAYERAS',
                  ...
                  font_family='times new roman',
                  italic=True)
    img4=ft.Image(src='playerasM.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txt5=ft.Text('PANTALONES',
                  ...
                  font_family='times new roman',
                  italic=True)
    img5=ft.Image(src='pantalonesM.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txt7=ft.Text('SUDADERAS',
                  ...
                  font_family='times new roman',
                  italic=True)
    img7=ft.Image(src='sudaderaM.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txt9=ft.Text('CHALECOS',
                  ...
                  font_family='times new roman',
                  italic=True)
    img9=ft.Image(src='chalecoM.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txth1=ft.Text('PLAYERAS',
                  ...
                  font_family='times new roman',
                  italic=True)
    imgh1=ft.Image(src='playerasH.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txth2=ft.Text('CAMISAS',
                  ...
                  font_family='times new roman',
                  italic=True)
    imgh2=ft.Image(src='camisasH.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txth3=ft.Text('PANTALONES',
                  ...
                  font_family='times new roman',
                  italic=True)
    imgh3=ft.Image(src='pantalonesH.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txth5=ft.Text('SUDADERAS',
                  ...
                  font_family='times new roman',
                  italic=True)
    imgh5=ft.Image(src='sudaderaH.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txth6=ft.Text('ABRIGOS',
                  ...
                  font_family='times new roman',
                  italic=True)
    imgh6=ft.Image(src='abrigoH.png',
                  width=100,
                  height=100,
                  border_radius=200)
    ...
    txth7=ft.Text('CHALECOS',
                  ...
                  font_family='times new roman',
                  italic=True)
    imgh7=ft.Image(src='chalecoH.png',
                  width=100,
                  height=100,
                  border_radius=200)
